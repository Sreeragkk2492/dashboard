...
import 'package:dashboard/core/widgets/cuatom_card.dart';
                      ...
                      Row(
                        children: [
                          ElevatedButton(
                              style: ButtonStyle(
                                ...
                                backgroundColor: selectedIndex == 0
                                    ...
                                    : WidgetStateProperty.all<Color>(
                                        Colors.transparent),
                                foregroundColor:
                                    WidgetStateProperty.all<Color>(isbutton1
                              ...
                              child: Text('Tab one')),
                          buildSizedboxW(kDefaultPadding / 2.w),
                          ElevatedButton(
                              style: ButtonStyle(
                                overlayColor: WidgetStateProperty.all(
                                    AppColors.buttonSuccessColor),
                                backgroundColor: selectedIndex == 1
                                    ...
                                    : WidgetStateProperty.all<Color>(
                                        Colors.transparent),
                                foregroundColor:
                                    WidgetStateProperty.all<Color>(isbutton2
                                        ? AppColors.whiteColor
                                        : selectedIndex == 1
                                            ? AppColors.whiteColor
                                            : AppColors.blackColor),
      ...
      child: SfCartesianChart(
          ...
          series: [
            ...
            LineSeries<_ChartData, String>(
                ...
                name: 'Gold',
                color: AppColors.buttonSuccessColor.withOpacity(0.4))
          ]),
    );
  }
            ...
            getTitlesWidget: (double value, TitleMeta meta) {
              return leftTitle[value.toInt()] != null
                  ? Text(leftTitle[value.toInt()].toString(),
                      style: TextStyle(
                          fontSize: Responsive.isMobile(context) ? 9.sp : 12.sp,
                          color: Colors.grey[400]))
                  : const SizedBox();
            },
            showTitles: true,
        ...
        LineChartBarData(
            ...
            belowBarData: BarAreaData(
              gradient: LinearGradient(
                ...
                colors: [
                  AppColors.buttonSuccessColor.withOpacity(0.4),
                  Colors.transparent
                ],
              ),
              show: true,
